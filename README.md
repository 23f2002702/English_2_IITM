# English 2 Solutions ✏️

This repository contains my personal collection of weekly notes, assignments, and solutions for the course **English 2** at BS Degree IIT Madras.
...
- **Clone it** to your computer with:  
  ```bash
  git clone https://github.com/YOUR-USERNAME/english2-iitm.git
